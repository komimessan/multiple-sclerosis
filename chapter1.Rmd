...
p1 <- subset(ms_data4, patient_id=="NIB446") ## select single patient ## NIB112 ##NDS668, NDS670
...
p1 <- subset(ms_data4, patient_id=="NIB664") ## select single patient ## NIB112 ##NDS668
p11 <- subset(p1, ntest_date=="1") ## select one test date (1)
