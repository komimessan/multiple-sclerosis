...
spiral_data_func <- function(data, patientID, ntest){
  ...
  for (j in n){
    if (p11_sub[j,"difficulty_level"]== dl1 & p11_sub.l1$y[1]>p11_sub.l1$y[n1]){
      p11_sub$x_norm[j] <- p11_sub$x[j] + norm.xo1
    } else if (p11_sub[j,"difficulty_level"]== dl1 & p11_sub.l1$y[1]<p11_sub.l1$y[n1]){
      p11_sub$x_norm[j] <- p11_sub$x[j] + norm.xi1
    } else if (p11_sub[j,"difficulty_level"]== dl2 & p11_sub.l2$y[1]>p11_sub.l2$y[n2]){
      p11_sub$x_norm[j] <- p11_sub$x[j] + norm.xo2
    } else if (p11_sub[j,"difficulty_level"]== dl2 & p11_sub.l2$y[1]<p11_sub.l2$y[n2]){
      p11_sub$x_norm[j] <- p11_sub$x[j] + norm.xi2
    } else if (p11_sub[j,"difficulty_level"]== dl3 & p11_sub.l3$y[1]>p11_sub.l3$y[n3]){
      p11_sub$x_norm[j] <- p11_sub$x[j] + norm.xo3
    } else if (p11_sub[j,"difficulty_level"]== dl3 & p11_sub.l3$y[1]<p11_sub.l3$y[n3]){
      p11_sub$x_norm[j] <- p11_sub$x[j] + norm.xi3
    } else {
