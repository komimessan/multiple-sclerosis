...
spiral_data <- spiral_data_func(ms_data4, "NIB655","1")
...
p1 <- subset(ms_data4, patient_id=="NDS668") ## select single patient ## NIB112 ##NDS668
p11 <- subset(p1, ntest_date=="1") ## select one test date (1)
p111 <- subset(p11, difficulty_level=="1") ## select single difficulty level (1)
p1111 <- subset(p111, trial_id == p111$trial_id[1]) ## "JSpymPxwdnXwvLzXpjym"
##
